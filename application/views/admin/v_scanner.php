...
<html>
    ...
    <body>
                ...
                <div class="panel-body text-center">
                    ...
                    <div class="col-md-6">
                        <div class="thumbnail" id="result">
                            ...
                            <form method="post" action="<?php echo base_url('transaksi/tambahData');?>">
                            <div class="caption">
                                <h3>Scanned </h3>
                                <span id="scanned-QR"></span>
                                <textarea type="text" name="imei_hp" id="hasil"  required="" onchange="this.form.submit()"></textarea> 
                                <input type="text" name="tgl_order" value="<?php echo jin_date(date('d-m-Y')) ?>" >
                                <br>
                                <div class="card-footer">
								<noscript><button id="tombol_p" type="submit" class="btn btn-primary">Submit</button></noscript>
				                <a href="<?php echo site_url('dashboard') ?>" class="btn btn-danger">
				                <i class="fa fa-list"></i> Kembali</a>
								</div>
                            </div>
                            </form>
                        </div>
		...
		function tampilkan_nilai_p() {
		    var scan=document.getElementById("scanned-QR").innerHTML;
		    var a = scan.substr(9,15);
