            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="<?= base_url('admin/attendance') ?>"><i class="fas fa-fw fa-table"></i> Data Absen</a>
                    </div>
                </div>
            </li>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            table = $('#myTable').DataTable({
                "processing": true,
                "serverSide": true,
                "ajax": "<?= base_url('admin/attendance/show'); ?>",
                dom: 'lBfrtip',
                buttons: [
                ...
                "columns": [{
                    ...
                    "render": function(data, type, row) {
                        if (row.cin === null) {
                            return "<a href='<?= base_url(); ?>admin/a_log/find/" + row.nik + "/" + row.tanggal + "' target='_blank'><span class='badge badge-success'>Find IN</span></a>";
                        } else {
                            return data;
                        }
                    }
                    ...
                    "render": function(data, type, row) {
                        if (row.cout === null) {
                            return "<a href='<?= base_url(); ?>admin/a_log/find/" + row.nik + "/" + row.tanggal + "' target='_blank'><span class='badge badge-success'>Find Out</span></a>";
                        } else {
                            return data;
                        }
                    }
        ...
        function monthlySummary() {
            $.ajax({
                url: "<?= base_url(); ?>admin/attendance/monthlySummary",
                type: "POST",
                // dataType: "json",
